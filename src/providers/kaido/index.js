/**
 * Kaido Provider (kaido.to)
 *
 * Reuses existing extractors with kaido.to as the base URL.
 * HTML structure is identical to 9animetv.to (same selectors work).
 */
...
export function createKaidoProvider() {
  return {
    name: "kaido",
    baseUrl: BASE,
